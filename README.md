...
| ------------- | ----------- | ------- |
| `aw_data`  | Search for data by taxonomic level, full species name, a bounding box, habitat, elevation or type.     |    `aw_data(scientific_name = "acanthognathus brevicornis")` <br> `aw_data(bbox = '37.77,-122.46,37.76,-122.47')` |
